                ...
                <div
                    ...
                    <div class="card">
                        <header class="card-heading-extra">
                            <div class="row">
                                <div class="col-8">
                                    <h3 class="mr-b-10 sub-heading-font-family fw-300"><?php echo htmlspecialchars($data["user_info"]["username"]); ?></h3>
                                    <span class="user--online"><?php if ($data["user_info"]["isOnline"] === "1") {
                                            echo "ONLINE";
                                        } else {
                                            echo "OFFLINE";
                                        } ?>
        ...
        <aside class="site-sidebar scrollbar-enabled clearfix">
            ...
            <div class="side-user">
                <a class="col-sm-12 media clearfix" href="javascript:void(0);">
                    ...
                    <div class="media-body hide-menu">
                        <h4 class="media-heading mr-b-5 text-uppercase"><?php echo htmlspecialchars($data["user_info"]["username"]); ?></h4>
            ...
            <nav class="sidebar-nav">
                <ul class="nav in side-menu">
                    <li><a href="/listed/player"><i class="material-icons list-icon">apps</i> <span
                                    class="hide-menu">Danh sách</span></a></li>
        ...
        <div class="main-wrapper clearfix">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-6 widget-holder">
                    <div class="widget-bg">
                        <div class="widget-body clearfix">
                            <div class="widget-counter">
                                <h6>Tổng số người chơi<small></small></h6>
                                <h3 class="h1"><span
                                            class="counter"><?php echo htmlspecialchars($data["amount_acc_player"]); ?></span>
                                </h3><i class="material-icons list-icon">account_box</i>
                            </div>
                            <!-- /.widget-counter -->
                        </div>
                ...
                <div class="col-md-4 col-6 widget-holder">
                    <div class="widget-bg bg-color-scheme text-inverse">
                        <div class="widget-body clearfix">
                            <div class="widget-counter">
                                <h6>Tổng số người chơi đang trong trận <small class="text-inverse"></small></h6>
                                <h3 class="h1"><span
                                            class="counter"><?php echo htmlspecialchars($data["amount_acc_playing"]); ?></span>
                                </h3><i class="material-icons list-icon">check_box</i>
                            </div>
                            <!-- /.widget-counter -->
                        </div>
                ...
                <div class="col-md-4 col-6 widget-holder">
                    <div class="widget-bg bg-primary text-inverse">
                        <div class="widget-body">
                            <div class="widget-counter">
                                <h6>Tổng số người chơi đang online <small class="text-inverse"></small></h6>
                                <h3 class="h1"><span
                                            class="counter"><?php echo htmlspecialchars($data["amount_acc_not_playing"]); ?></span>
                                </h3><i
                                        class="material-icons list-icon">indeterminate_check_box</i>
                            </div>
                            <!-- /.widget-counter -->
            ...
            <div class="row">
                <div class="col-md-12 widget-holder">
                    <div class="widget-bg">
                        <div class="widget-body clearfix">
                            <h5 class="box-title">Tình trạng người chơi</h5>
