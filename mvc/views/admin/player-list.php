            ...
            <div class="side-user">
                <a class="col-sm-12 media clearfix" href="javascript:void(0);">
                    ...
                    <div class="media-body hide-menu">
                        <h4 class="media-heading mr-b-5 text-uppercase"><?php echo htmlspecialchars($data["user_info"]["userame"]); ?></h4>
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h5 class="mr-0 mr-r-5">Danh sách người chơi</h5>
                ...
                <div class="page-title-right d-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="/listed/player">Người chơi</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
                            ...
                            <div class="widget-body clearfix">
                                <table class="table table-editable" data-toggle="datatables">
                                    ...
                                    foreach ($result as $key => $value) {
                                        $parament = $value['AccountID'];
                                        $link1 = '/view/player/' . $parament;
                                        $link2 = '/delete/player/' . $parament;
                                        $state = "";
                                        if ($value['isOnline'] === "0") {
                                            $state = "Offline";
                                        } else {
                                            if ($value['isPlaying'] === "0") {
                                                $state = "Online";
                                            } else {
                                                $state = "Trong trận";
                                            }
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><?php echo htmlspecialchars($value['AccountID']); ?></td>
                                            <td><?php echo htmlspecialchars($value['username']); ?></td>
                                            <td><?php echo htmlspecialchars($value['point']); ?></td>
