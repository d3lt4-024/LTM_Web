                        ...
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <form action="<?php echo $link ?>" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l2">Điểm</label>
                                        <div class="col-md-9">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                            class="material-icons list-icon">check</i> </span>
                                                <input class="form-control" name="Point"
                                                       placeholder="Điểm" maxlength="10"
                                                       value="<?php echo htmlspecialchars($data["default"]["point"]); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
